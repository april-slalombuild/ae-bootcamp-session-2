...
- [UI Guidelines](../docs/ui-guidelines.md) - Visual design, components, accessibility, and layout standards
- [Testing Guidelines](../docs/testing-guidelines.md) - Unit, integration, and E2E testing standards
